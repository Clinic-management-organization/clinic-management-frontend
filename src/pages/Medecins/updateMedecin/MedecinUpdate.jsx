...
import { getMedecinByID, updateMedecinByID } from "../../../services/MedecinServices";
import {
  Container,
  CssBaseline,
  Box,
    ...
    return (
      <div className="user">
        <div className="userTitleContainer">
          ...
          <button onClick={() => { navigate('/medecins/add') }} className="userAddButton">Ajouter</button>
        </div>
          ...
          <div className="userShow">
            ...
            <div className="userShowBottom">
              ...
              <div className="userShowInfo">
                ...
                <span className="userShowInfoTitle">{`${toDate(medecin?.dateNaissance)}`}</span>
              </div>
